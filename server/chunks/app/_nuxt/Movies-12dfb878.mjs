...
import { defineComponent, ref, withCtx, unref, createVNode, openBlock, createBlock, KeepAlive, Fragment, renderList, useSSRContext } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(Mainlayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="text-xl capitalize mb-3 ml-7 text-purple-600"${_scopeId}> discover new movies :</h2>`);
            if (unref(wait)) {
            ...
            return [
              createVNode("h2", { class: "text-xl capitalize mb-3 ml-7 text-purple-600" }, " discover new movies :"),
              unref(wait) ? (openBlock(), createBlock(_component_Loading, { key: 0 })) : (openBlock(), createBlock(KeepAlive, { key: 1 }, [
                createVNode("div", { class: "grid gap-x-2 justify-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(Movies), (Movie) => {
...
//# sourceMappingURL=Movies-12dfb878.mjs.map
