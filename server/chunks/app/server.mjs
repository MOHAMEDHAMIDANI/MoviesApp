import { hasInjectionContext, getCurrentInstance, unref, version, toRef, isRef, inject, defineAsyncComponent, ref, watchEffect, watch, useSSRContext, createApp, reactive, effectScope, isReactive, toRaw, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, getCurrentScope, onScopeDispose, nextTick, shallowRef, computed, isReadonly, markRaw, toRefs, isShallow, defineComponent, h, Suspense, Transition } from 'vue';
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-4c8b4e6b.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-b64a7625.mjs').then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Favorite-a477a7d4.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-d4ae1b03.mjs').then((m) => m.default || m)
  },
  {
    name: "Movies",
    path: "/Movies",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Movies-12dfb878.mjs').then((m) => m.default || m)
  },
  {
    name: "Series",
    path: "/Series",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Series-696e8ceb.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-35db8655.mjs').then((m) => m.default || m)
  }
];
...
const stor_1OOIIKv04R = /* @__PURE__ */ defineNuxtPlugin((NuxtApp) => {
  return {
    provide: {
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-6f3361c5.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-18b3bbb9.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useRoute as a, useRequestFetch as b, createError as c, useState as d, entry$1 as default, useHead as e, useRouter as f, navigateTo as n, resolveUnrefHeadInput as r, useNuxtApp as u };
